...
from whole_body_tracking.robots.g1 import G1_23DOF_ACTION_SCALE, G1_23DOF_CYLINDER_CFG, G1_ACTION_SCALE, G1_CYLINDER_CFG
...
@configclass
class G1Flat23DOFEnvCfg(TrackingEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class G1Flat23DOFWoStateEstimationEnvCfg(G1Flat23DOFEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.observations.policy.motion_anchor_pos_b = None
        self.observations.policy.base_lin_vel = None
...
@configclass
class G1Flat23DOFLowFreqEnvCfg(G1Flat23DOFEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.decimation = round(self.decimation / LOW_FREQ_SCALE)
        self.rewards.action_rate_l2.weight *= LOW_FREQ_SCALE
