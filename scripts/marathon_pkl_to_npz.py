...
"""
    ...
    python scripts/casbot_pkl_to_npz.py -f path_to_input.pkl --input_fps 30 --headless
"""
...
from whole_body_tracking.robots.marathon import MARATHON_001_CYLINDER_CFG
